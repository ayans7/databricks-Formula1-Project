...
using csv
options (path "/mnt/formula1datal7/raw/circuits.csv", header true);
...
using csv
options (path "/mnt/formula1datal7/raw/races.csv", header true);
...
using json
options (path "/mnt/formula1datal7/raw/constructors.json");
...
using json
options (path "/mnt/formula1datal7/raw/drivers.json")
...
using json
options (path "/mnt/formula1datal7/raw/results.json")
...
using json
options (path "/mnt/formula1datal7/raw/pit_stops.json", multiLine true)
...
using csv
options (path "/mnt/formula1datal7/raw/lap_times")
...
using json
options (path "/mnt/formula1datal7/raw/qualifying", multiLine true)
