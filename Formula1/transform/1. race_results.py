...
constructors_df = spark.read.load(f"{processed_folder_path}/constructors", format="delta") \
    .withColumnRenamed("name","team")

# COMMAND ----------

circuits_df = spark.read.load(f"{processed_folder_path}/circuits", format="delta") \
